...
def run():
    # file_lst = ["./config/bert-base-multilingual-cased/retrieval_config_6.json",
    ...
    file_lst = ["./config/idf-testing/retrieval_config_1.json",
                "./config/idf-testing/retrieval_config_2.json",
                "./config/idf-testing/retrieval_config_3.json",
                "./config/idf-testing/retrieval_config_4.json",
                ]
